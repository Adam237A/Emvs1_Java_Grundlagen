...
//--------------------------------------------------------------------------------------------------------------
        ...
        //      2.This behavior occurs because the variable iteratorEx1 is never incremented, so the condition iteratorEx1 < 10 always remains true.
        //       3.You can modify the code by adding iteratorEx1++; inside the do-while loop to achieve the desired output.
         //      4.if the first value of iteratorEx1 was set to 100, the loop would execute exactly once, printing "iteratorEx1:100" before terminating because the condition 100 < 10 evaluates to false.
        //--------------------------------------------------------------------------------------------------------------
